 ...
 *
  ...
  https://118.25.100.74:8443/static/js/zhichi_dd.js
  https://localhost:8443/static/js/zhichi_dd.js

  一行代码-本地
 $("body").append(`<script src="https://localhost:8443/static/js/zhichi_dd.js" type="text/javascript" charset="utf-8"></script>`);

 一行代码-外网
 $("body").append(`<script src="https://118.25.100.74:8443/static/js/zhichi_dd.js" type="text/javascript" charset="utf-8"></script>`);

 document.write(`<script src="https://localhost:8443/static/js/zhichi_dd.js" type="text/javascript" charset="utf-8"></script>`)
 */
